...
> Must read: this master file lives at `~/Developer/agent-scripts/docs/RELEASING-MAC.md`. Open it alongside any repo-local release doc and reconcile differences before starting.
...
2. Open the repo’s release doc (if any) and this master file (`~/Developer/agent-scripts/docs/RELEASING-MAC.md`); resolve any conflicts in favor of the current project owner’s direction.
...
- [ ] Opened repo-local release doc and this master guide (`~/Developer/agent-scripts/docs/RELEASING-MAC.md`); resolved any conflicts.
