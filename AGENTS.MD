...
- Commit workflow: stage only intended files with `git add <files>`, then commit with `git commit -m "<type>: <summary>"`.
...
- Create commits directly: `git commit -m "<type>: <summary>"`.
